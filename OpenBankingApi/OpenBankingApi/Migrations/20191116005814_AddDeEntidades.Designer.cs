...
namespace OpenBankingApi.Migrations
{
    ...
    [Migration("20191116005814_AddDeEntidades")]
    partial class AddDeEntidades
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenBankingApi.Domain.Models.LogSistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("LogSistemaTipoId");

                    b.HasKey("Id");

                    b.HasIndex("ClienteId");

                    b.HasIndex("LogSistemaTipoId");

                    b.ToTable("Logs");
                });

            modelBuilder.Entity("OpenBankingApi.Domain.Models.LogSistemaTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OpenBankingApi.Domain.Models.LogSistema", b =>
                {
                    ...
                    b.HasOne("OpenBankingApi.Domain.Models.LogSistemaTipo", "LogSistemaTipo")
                        .WithMany()
                        .HasForeignKey("LogSistemaTipoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
